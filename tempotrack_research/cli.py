...
def build_parser() -> argparse.ArgumentParser:
    ...
    q = v9.add_parser("precompute-qdic-sidecar"); q.add_argument("--repo", default="."); q.add_argument("--event-cache", required=True); q.add_argument("--features"); q.add_argument("--feature-source"); q.add_argument("--recent-k", type=int, default=8); q.add_argument("--alpha-fast", type=float, default=0.70); q.add_argument("--alpha-slow", type=float, default=0.15); q.add_argument("--memory-capacity", type=int, default=64); q.add_argument("--memory-dedup-cos", type=float, default=0.95); q.add_argument("--output", required=True); q.set_defaults(func=_psmr_v9)
    q = v9.add_parser("build-qdic-features"); q.add_argument("--repo", default="."); q.add_argument("--event-cache", required=True); q.add_argument("--sidecar", required=True); q.add_argument("--output", required=True); q.add_argument("--recent-k", type=int, default=8); q.add_argument("--alpha-fast", type=float, default=0.70); q.add_argument("--alpha-slow", type=float, default=0.15); q.add_argument("--memory-capacity", type=int, default=64); q.add_argument("--memory-dedup-cos", type=float, default=0.95); q.add_argument("--context-candidate-top-k", type=int, default=64); q.add_argument("--decision-candidate-top-k", type=int, default=8); q.set_defaults(func=_psmr_v9)
    q = v9.add_parser("train-qdic"); q.add_argument("--repo", default="."); q.add_argument("--features-dir", required=True); q.add_argument("--output", required=True); q.add_argument("--device", default="cpu"); q.add_argument("--epochs", type=int, default=12); q.add_argument("--seed", type=int, default=0); q.set_defaults(func=_psmr_v9)
