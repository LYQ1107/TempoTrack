...
def build_parser() -> argparse.ArgumentParser:
    ...
    q = v9.add_parser("sweep-psmr"); q.add_argument("--repo", default="."); q.add_argument("--event-cache", required=True); q.add_argument("--protocol", required=True, help="FROZEN_DEV, VAL_BASE_ADAPTED, TEST_BASE_ADAPTED, or TEST_FULL_ORACLE"); q.add_argument("--search-space", required=True); q.add_argument("--checkpoint"); q.add_argument("--structural-limit", type=int); q.add_argument("--structural-shard-index", type=int, default=0); q.add_argument("--structural-shard-count", type=int, default=1); q.add_argument("--output", required=True); q.set_defaults(func=_psmr_v9)
